...
?>
      ...
      <center>
        ...
        <h2>Edit Pengguna <?php echo $data['nama_petugas']; ?></h2>
      <center>
  ...
  $idpetugas=$data['id_petugas']; 
      ...
      {
      ?>
 <option class="bg-light" value="<?php echo $row['id_petugas']; ?>" <?php if($row['id_petugas']=="$idpetugas"){?> selected="selected" <?php } ?>><?php echo $row['level']; ?></option>
 <?php
